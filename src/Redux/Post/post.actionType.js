...
export const LIKE_ALL_POST_REQUEST = "LIKE_ALL_POST_REQUEST";
export const LIKE_ALL_POST_SUCCESS = "LIKE_ALL_POST_SUCCESS";
export const LIKE_ALL_POST_FAILURE = "LIKE_ALL_POST_FAILURE";
